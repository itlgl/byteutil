...
public class ByteUtilTest {
	...
	public void toHexTest() {
		...
		String hexResult = ByteUtils.toHex(bs);
		Assert.assertEquals(hex, hexResult);

		String hex2 = "bbff";
		String hexResult2 = ByteUtils.toHex(bs, bs.length - 2);
		Assert.assertEquals(hex2, hexResult2);
		
		String hex3 = "aabb";
		String hexResult3 = ByteUtils.toHex(bs, bs.length - 3, bs.length - 1);
		Assert.assertEquals(hex3, hexResult3);
		
		int value4 = 0xab;
		String hex4 = "ab";
		String hexResult4 = ByteUtils.toHex(value4, 1);
		Assert.assertEquals(hex4, hexResult4);
		
		int value5 = 0xabcd;
		String hex5 = "abcd";
		String hexResult5 = ByteUtils.toHex(value5, 2);
		Assert.assertEquals(hex5, hexResult5);
		
		int value6 = 0xabcdef;
		String hex6 = "abcdef";
		String hexResult6 = ByteUtils.toHex(value6, 3);
		Assert.assertEquals(hex6, hexResult6);
		
		int value7 = 0xabcdefab;
		String hex7 = "abcdefab";
		String hexResult7 = ByteUtils.toHex(value7, 4);
	...
	public void fromShortTest() {
		...
		byte[] ret = ByteUtils.fromShort(s);
	...
	public void toShortTest() {
		short s = (short) 0xabcd;
		byte[] b = new byte[]{(byte) 0xab, (byte) 0xcd};
		short ret = ByteUtils.toShort(b[0], b[1]);
	...
	public void toIntTest() {
		int i = 0xabcdefab;
		byte[] b = new byte[]{(byte) 0xab,(byte) 0xcd,(byte) 0xef,(byte) 0xab};
		int ret = ByteUtils.toInt(b[0],b[1],b[2],b[3]);
	...
	public void combineTest() {
		...
		byte[] ret = ByteUtils.combine((byte)0xab, new byte[]{(byte) 0xab, (byte) 0xab}, "abab", 0xefab, (long) 0xefefab);
		Assert.assertArrayEquals(b, ret);
	}
}
